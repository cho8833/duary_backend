...
/*
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -trimpath -tags lambda.norpc -o bootstrap api/start_duary/main/main.go && chmod 755 bootstrap && zip  build/package/start_duary.zip bootstrap && rm bootstrap
*/
