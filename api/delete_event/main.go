...
/*
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -trimpath -tags lambda.norpc -o bootstrap api/delete_event/main.go && chmod 755 bootstrap && zip  build/package/delete_event.zip bootstrap && rm bootstrap
*/
