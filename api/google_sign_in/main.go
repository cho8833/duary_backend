...
/*
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -trimpath -tags lambda.norpc -o bootstrap api/google_sign_in/main.go && chmod 755 bootstrap && zip  build/package/google_sign_in.zip bootstrap && rm bootstrap
*/
