...
/*
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -trimpath -tags lambda.norpc -o bootstrap api/disconnect_couple/main.go && chmod 755 bootstrap && zip  build/package/disconnect_couple.zip bootstrap && rm bootstrap
*/
