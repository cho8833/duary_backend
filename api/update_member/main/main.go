...
/*
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -trimpath -tags lambda.norpc -o bootstrap api/update_member/main/main.go && chmod 755 bootstrap && zip  build/package/update_member_api.zip bootstrap && rm bootstrap
*/
