...
/*
GOOS=linux GOARCH=amd64 go build -ldflags="-s -w" -trimpath -tags lambda.norpc -o bootstrap api/reissue_token/main/main.go && chmod 755 bootstrap && zip  build/package/auth/reissue_token.zip bootstrap && rm bootstrap
*/
